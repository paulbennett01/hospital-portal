...
const Videos = () => {
    return (
        ...
        <div className="video-info">
        <h1 className="video-text">Watch this video on: The MRI Department</h1>
        <iframe className="video" width="560" height="315" src="https://www.youtube.com/embed/Q_Pa6KFL1Nw?si=ttqnQdW5-bzp7LiT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        </>
    )
};
