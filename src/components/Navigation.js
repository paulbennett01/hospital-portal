        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <Link to="/Login"
          className='hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]'>Login</Link>
      
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <Link to="/register"
          className='hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]'>Register</Link>
            </li>
          </ul>
        </div>
